...
const Footer = () => {
  return (
    ...
    >
      <div className="flex flex-col   w-full  h-full md:h-44 md:px-5">
        <div className=" p-5 flex-col md:gap-5 gap-2 md:flex-row flex w-full justify-between  ">
          <div className=" shadow-lg shadow-gray-500 flex flex-col   rounded-lg  border-4 border-yellow-600 hover:transition-transform duration-100  hover:scale-105 w-full  md:w-1/3 h-full  p-3">
